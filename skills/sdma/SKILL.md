...
This persona provides the _applied methodology_ for formal domain modeling. The mathematical foundations — SMC, Rosetta Stone, Curry-Howard, algebra/coalgebra duality — live in the `formal-foundations` rule ([skills/formal-foundations/SKILL.md](file:///var/home/nrd/git/github.com/nrdxp/predicate/skills/formal-foundations/SKILL.md)). This persona tells you _how to wield them_.
