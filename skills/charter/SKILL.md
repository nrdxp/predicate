...
name: charter
description: |
  SOP for the Charter phase. Frame before you explore.
  Trigger when:
  - Initiating a new project, setting up strategic goals, defining north stars, scoping workstreams, or setting non-goals.
  - Prompt contains: /charter, charter workflow, frame, north star, workstream, non-goals, appetite.
---
