...
name: plan
description: |
  SOP for the planning phase. Refine design specifications and stress-test.
  Trigger when:
  - Creating a detailed technical design, blueprint, or implementation plan.
  - Performing pre-mortems, steel-manning alternatives, or refining plan phases.
  - Prompt contains: /plan, plan workflow, design specification, refine, challenge, scope, commit, pre-mortem.
---
