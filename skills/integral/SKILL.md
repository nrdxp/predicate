...
name: integral
description: |
  Cognitive reasoning and meta-project analysis frameworks.
  Trigger when:
  - Analyzing complex system architectures, evaluating multi-perspective design trade-offs, or framing problems.
  - Applying systems thinking, holonic analysis, or evaluating assumptions.
  - Prompt contains keywords: integral, holon, AQAL, Spiral Development, red, blue, orange, green, teal, deep think, sycophancy test, premise verification.
---

# Integral Problem-Solving Framework

**Disposition directive:** Approach problems through a holonic lens—every component exists as both a whole and a part of larger systems. This predicate shapes _how_ you reason, complementing the engineering rules in `engineering.md`.
