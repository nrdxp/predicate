...
name: plan-review
description: |
  Post-execution review of plan commits.
  Trigger when:
  - Analyzing plan outcomes, documenting lessons learned, or closing the loop on a plan.
  - Prompt contains: /plan-review, post-execution, plan closure, retrospective.
---
